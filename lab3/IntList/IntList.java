...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        IntList Q1= new IntList(A.head,null);
        IntList Q=Q1;
        IntList p1=A;//pointer
        IntList p2=B;//pointer
        p1=p1.tail;
        while (p1!=null){
            Q1.tail=new IntList(p1.head,null);
            p1=p1.tail;
            Q1=Q1.tail;
        }
        while (p2!=null){
            Q1.tail=new IntList(p2.head,null);
            p2=p2.tail;
            Q1=Q1.tail;
        }
        return Q;
    ...
    public static IntList reverse(IntList A){
        ...
        IntList read=A.tail;
        IntList toread=A.tail.tail;
        IntList reversed=IntList.list(A.head);
        while (read!=null){
            toread=read.tail;
            read.tail=reversed;
            reversed=read;
